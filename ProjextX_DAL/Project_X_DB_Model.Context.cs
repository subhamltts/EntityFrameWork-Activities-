...
namespace ProjextX_DAL
{
    ...
    public partial class ProjectX_DB : DbContext
    {
        public ProjectX_DB()
            : base("name=ProjectX_DB")
        {
        }
        ...
        [DbFunction("ProjectX_DB", "udfGetBatchList")]
        public virtual IQueryable<udfGetBatchList_Result> udfGetBatchList(Nullable<int> strength)
        {
            var strengthParameter = strength.HasValue ?
                new ObjectParameter("Strength", strength) :
                new ObjectParameter("Strength", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<udfGetBatchList_Result>("[ProjectX_DB].[udfGetBatchList](@Strength)", strengthParameter);
        }
